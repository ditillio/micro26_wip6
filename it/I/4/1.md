...
<p class="figure-label" id="gr_equilibrium/mktdemand">FIGURA 4.1</p>
...
Come nella <a href="{{ site.baseurl }}/it/I/4/1#gr_equilibrium/mktdemand">Figura 4.1</a>, stiamo mantenendo costanti reddito dei consumatori e prezzo dei beni sostituti.
</span>
...
<p class="figure-label" id="gr_equilibrium/compeqSR">FIGURA 4.3</p>
...
<p class="figure-label" id="gr_equilibrium/mktsupplyLR">FIGURA 4.4</p>
...
<p class="figure-label" id="gr_equilibrium/compeqLR">FIGURA 4.5</p>
